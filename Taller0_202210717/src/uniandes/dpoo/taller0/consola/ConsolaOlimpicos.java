...
public class ConsolaOlimpicos
{
	...
	{
		String nombre_atleta= input("ingrese el numre del atleta que desea consultar");
		String nombre_pais= calculadora.PaisAtleta(nombre_atleta);
		System.out.println("El atleta es del pais: " + nombre_pais);
